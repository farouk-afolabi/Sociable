 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of="storage";function vI(n,e,t){return n=ie(n),$T(n,e,t)}function TI(n){return n=ie(n),zT(n)}function II(n,e){return n=ie(n),KT(n,e)}function wI(n=So(),e){n=ie(n);const r=Us(n,of).getImmediate({identifier:e}),s=yl("storage");return s&&XT(r,...s),r}function XT(n,e,t,r={}){QT(n,e,t,r)}function YT(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new ka(t,r,s,e,Yt)}function JT(){Ht(new bt(of,YT,"PUBLIC").setMultipleInstances(!0)),$e(dl,fl,""),$e(dl,fl,"esm2017")}JT();export{sI as a,wI as b,ZT as c,hI as d,kv as e,uI as f,tI as g,lI as h,fm as i,rI as j,mI as k,cI as l,TI as m,pI as n,aI as o,gI as p,iI as q,II as r,eI as s,fI as t,vI as u,dI as v,oI as w,EI as x,yI as y,_I as z};
