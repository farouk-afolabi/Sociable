 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of="storage";function TI(n,e,t){return n=se(n),$T(n,e,t)}function II(n){return n=se(n),zT(n)}function wI(n,e){return n=se(n),KT(n,e)}function AI(n=So(),e){n=se(n);const r=Us(n,of).getImmediate({identifier:e}),s=yl("storage");return s&&XT(r,...s),r}function XT(n,e,t,r={}){QT(n,e,t,r)}function YT(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new ka(t,r,s,e,Yt)}function JT(){Ht(new bt(of,YT,"PUBLIC").setMultipleInstances(!0)),$e(dl,fl,""),$e(dl,fl,"esm2017")}JT();export{EI as A,iI as a,AI as b,eI as c,ZT as d,dI as e,kv as f,nI as g,lI as h,fm as i,hI as j,sI as k,uI as l,gI as m,II as n,cI as o,mI as p,oI as q,wI as r,tI as s,_I as t,TI as u,pI as v,aI as w,fI as x,vI as y,yI as z};
